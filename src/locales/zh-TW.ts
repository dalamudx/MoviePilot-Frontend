export default {
  ...
  theme: {
    ...
    customCssSaveSuccess: '自定義CSS儲存成功，請刷新頁面生效！',
    customCssSaveFailed: '儲存自定義CSS到服務端失敗',
  ...
  login: {
    ...
    loginWithSSO: '使用 {provider} 登錄',
    oauthLoginFailed: 'SSO 登錄失敗',
    oauthCallbackError: 'OAuth 回調處理失敗，請重新登錄',
    backToLogin: '返回登錄頁',
  },
  menu: {
    start: '開始',
  ...
  settingTabs: {
    ...
    search: {
      title: '搜尋 & 下載',
      description: '搜尋數據源（TheMovieDb、豆瓣、Bangumi）、下載任務標籤、搜尋站點',
    },
    subscribe: {
      title: '訂閱',
  ...
  notification: {
    ...
    type: '類型',
    typeHint: '通知渠道類型',
    customTypeHint: '自定義通知類型，用於外掛實現場景',
  ...
  workflow: {
    ...
    invokePlugin: {
      ...
      actionid: '動作ID',
      actionParams: '動作參數',
      loadPluginSettingFailed: '加載外掛設置失敗',
    },
    note: {
      title: '備註',
      subtitle: '添加流程說明註釋',
  ...
  subscribe: {
    ...
    noSubscribeData: '請通過搜尋添加電影、電視劇訂閱。',
    sharer: '分享人',
    follow: '關注',
    unfollow: '取消關注',
  ...
  resource: {
    ...
    searching: '正在搜尋，請稍候...',
    noData: '沒有數據',
    noResourceFound: '未搜尋到任何資源',
    aiRecommend: '智慧推薦',
    reRecommend: '重新生成推薦',
    aiRecommendError: '智慧推薦失敗',
  },
  browse: {
    actor: '演員',
  },
  ...
  storage: {
    name: '名稱',
    type: '類型',
    customTypeHint: '自定義存儲類型，用於外掛等場景',
  ...
  site: {
    ...
    hints: {
      ...
      cookie: '站點請求頭中的Cookie資訊',
      userAgent: '獲取Cookie的瀏覽器對應的User-Agent',
      authorization: '站點請求頭中的Authorization資訊，特殊站點需要',
  ...
  setting: {
    ...
    system: {
      ...
      recognizeSourceHint: '設置默認媒體資訊識別數據源',
      ...
      githubTokenHint: '用於提高外掛等訪問Github API時的限流閾值，建議配置，否則外掛可能無法正常使用',
      ocrHost: '驗證碼識別服務器',
      ocrHostHint: '用於站點簽到、更新站點Cookie等識別驗證碼',
      aiAgent: '啟用智慧助手',
      aiAgentEnable: '啟用智慧助手',
      aiAgentEnableHint: '啟用後可使用智慧助手功能，需要配置LLM相關參數',
      llmProvider: 'LLM提供商',
      ...
      aiAgentGlobal: '全局智慧助手',
      aiAgentGlobalHint: '啟用全局智慧助手功能，所有消息對話均使用智慧體回答而不用使用/ai命令',
      advancedSettings: '高級設置',
      advancedSettingsDesc: '系統進階設置，特殊情況下才需要調整',
      downloaders: '下載器',
      downloadersDesc: '只有默認下載器才會被默認使用。',
      aiRecommendEnabled: '搜尋結果智慧推薦',
      aiRecommendEnabledHint: '啟用搜尋結果智慧推薦功能，開啟後將在搜尋結果頁面顯示智慧推薦按鈕，可根據用戶偏好智慧推薦資源',
      aiRecommendUserPreference: '用戶偏好',
      aiRecommendUserPreferenceHint: '設置智慧推薦時的用戶偏好，例如：4K WEB-DL Dolby Vision',
      aiRecommendMaxItems: '智慧推薦分析條目上限',
      aiRecommendMaxItemsHint: '限制發送給智慧助手進行分析的搜尋結果數量，數量越多分析越慢且消耗 Token 越多，建議先手動篩選，篩選出大致範圍後再進行智慧推薦',
      mediaServers: '媒體服務器',
      ...
      log: '日誌',
      lab: '實驗室',
      downloaderSaveSuccess: '下載器設置儲存成功',
      downloaderSaveFailed: '下載器設置儲存失敗！',
      defaultDownloaderNotice: '未設置默認下載器，已將【{name}】作為默認下載器',
      mediaServerSaveSuccess: '媒體服務器設置儲存成功',
      mediaServerSaveFailed: '媒體服務器設置儲存失敗！',
      saveFailed: '設置儲存失敗：{message}！',
      basicSaveSuccess: '基礎設置儲存成功',
      advancedSaveSuccess: '高級設置儲存成功',
      copySuccess: '已複製到剪貼板！',
      ...
      authPasskeyEnable: '通行密鑰',
      authPasskeyEnableHint: '顯示通行密鑰(Passkey)登錄按鈕',
      authSettings: '認證設置',
      authSettingsDesc: '設置登錄相關功能',
      authEnable: '啟用單點登錄',
      authProviderType: '認證類型',
      authProviderName: '顯示名稱',
      authProviderNameHint: '登錄按鈕上顯示的名稱',
      authClientId: 'Client ID',
      authClientIdHint: 'OAuth2 Client ID',
      authClientSecret: 'Client Secret',
      authClientSecretHint: 'OAuth2 Client Secret',
      authAuthorizationEndpoint: '授權端點 (Authorization URL)',
      authAuthorizationEndpointHint: '例如: https://auth.example.com/application/o/authorize/',
      authTokenEndpoint: 'Token 端點',
      authTokenEndpointHint: '例如: https://auth.example.com/application/o/token/',
      authUserinfoEndpoint: '用戶資訊端點',
      authUserinfoEndpointHint: '例如: https://auth.example.com/application/o/userinfo/',
      authRedirectUri: '回調地址 (Redirect URI) - 可選',
      authRedirectUriHint: '通常留空即可，系統會自動生成。如需手動指定，請填寫完整URL',
      authScope: 'Scope',
      authScopeHint: '請求的權限範圍，例如: openid profile email',
      authUsernameField: '用戶名對映欄位',
      authUsernameFieldHint: '從用戶資訊中作為用戶名的欄位，例如: preferred_username',
      authNewUserPermissions: '新用戶默認權限',
      authNewUserPermissionsHint: '逗號分隔，例如: search,discovery,subscribe,manage',
      authAvatarField: '頭像欄位',
      authAvatarFieldHint: '例如: picture 或 avatar',
      authAutoCreateUser: '自動創建用戶',
      authAutoCreateUserHint: '新用戶首次登錄時自動創建賬號',
      authSyncEmail: '同步郵箱',
      authSyncEmailHint: '每次登錄時同步用戶資訊中的郵箱地址',
      authSyncAvatar: '同步頭像',
      authSyncAvatarHint: '每次登錄時同步用戶資訊中的頭像圖片',
      authSaveSuccess: '認證設置儲存成功',
      ...
      pluginStatisticShare: '上報外掛安裝數據',
      pluginStatisticShareHint: '上報外掛安裝數據給服務器，用於統計展示外掛安裝情況',
      ...
      tmdbApiDomainHint: '自定義themoviedb API網域或代理地址',
      tmdbApiDomainRequired: '請輸入TMDB API網域',
      tmdbImageDomain: 'TMDB 圖片服務地址',
      tmdbImageDomainPlaceholder: 'image.tmdb.org',
      tmdbImageDomainHint: '自定義themoviedb圖片服務網域或代理地址',
      tmdbImageDomainRequired: '請輸入圖片服務網域',
      ...
      scrapOriginalImageHint: '刮削原語种圖片，否则數據元數據語种圖片',
      ...
      pipProxyHint: '使用代理加速外掛等pip庫安裝速度',
      dohEnable: 'DNS Over HTTPS',
      dohEnableHint: '使用DOH對特定網域進行解析，以防止DNS污染',
      ...
      dohDomainsHint: '使用DOH解析的網域，多個網域使用逗號分隔',
      debug: '調試模式',
      ...
      pluginAutoReload: '外掛熱加載',
      pluginAutoReloadHint: '修改外掛文件後自動重新加載，開發外掛時使用',
      ...
      tokenizedSearch: '分詞搜尋',
      tokenizedSearchHint: '提升整理歷史記錄搜尋精度，但可能增加性能開銷和意外結果',
      tmdbLanguage: {
        zhCN: '簡體中文',
        zhTW: '繁體中文',
        en: '英文',
      ...
      customizeWallpaperApiHint: '會獲取 API 返回內容中所有安全設置中允許的圖片地址，需要設置安全網域白名單',
      customizeWallpaperApiRequired: '必填項；請輸出自定義壁紙API',
      securityImageDomains: '安全圖片網域',
      securityImageDomainsHint: '允許緩存的圖片網域白名單，用於控制可信任的圖片來源',
      noSecurityImageDomains: '暫無安全網域',
      securityImageDomainAdd: '添加網域，如：image.tmdb.org',
      proxyHost: '代理服務器',
      ...
      episodeNfo: 'NFO',
      episodeThumb: '縮略圖',
      scrapingSwitchSaveFailed: '刮削開關設定儲存失敗：{message}',
      scrapingSwitchSaveError: '刮削開關設定儲存失敗',
    },
    site: {
      siteSync: '站點同步',
      ...
      userKey: '用戶KEY',
      userKeyHint: 'CookieCloud瀏覽器外掛生成的用戶KEY',
      e2ePassword: '端對端加密密碼',
      e2ePasswordHint: 'CookieCloud瀏覽器外掛生成的端對端加密密碼',
      autoSyncInterval: '自動同步間隔',
      autoSyncIntervalHint: '從CookieCloud服務器自動同步站點Cookie到MoviePilot的時間間隔',
      syncBlacklist: '同步網域黑名單',
      syncBlacklistPlaceholder: '多個網域,分割',
      syncBlacklistHint: 'CookieCloud同步網域黑名單，多個網域,分割',
      userAgent: '瀏覽器User-Agent',
      userAgentHint: 'CookieCloud外掛所在的瀏覽器的User-Agent',
    ...
    notification: {
      ...
      templateSaveFailed: '模板儲存失敗！',
      templateSaveSuccess: '模板儲存成功',
      ...
      startTime: '開始時間',
      endTime: '結束時間',
      saveSuccess: '通知設置儲存成功',
      saveFailed: '通知設置儲存失敗！',
      switchSaveSuccess: '消息類型開關儲存成功',
      switchSaveFailed: '消息類型開關儲存失敗！',
      timeSaveSuccess: '通知發送時間儲存成功',
      timeSaveFailed: '通知發送時間儲存失敗！',
      channel: '通知',
      wechat: '微信',
      resourceDownload: '資源下載',
      mediaImport: '整理入庫',
    ...
    words: {
      ...
      identifierSaveSuccess: '自定義識別詞儲存成功',
      identifierSaveFailed: '自定義識別詞儲存失敗！',
      ...
      releaseGroupSaveSuccess: '自定義製作組/字幕組儲存成功',
      releaseGroupSaveFailed: '自定義製作組/字幕組儲存失敗！',
      ...
      customizationSaveSuccess: '自定義占位符儲存成功',
      customizationSaveFailed: '自定義占位符儲存失敗！',
      ...
      excludeWordsSaveSuccess: '文件整理屏蔽詞儲存成功',
      excludeWordsSaveFailed: '文件整理屏蔽詞儲存失敗！',
    },
    search: {
      basicSettings: '基礎設置',
      basicSettingsDesc: '設定數據源、規則組等基礎資訊',
      recognizeSource: '識別數據源',
      recognizeSourceDesc: '默認使用TMDB。豆瓣識別中文作品通常更友好，但有些國外作品資訊不完整。',
      themoviedb: 'TheMovieDb',
      douban: '豆瓣',
      ...
      downloadSite: '搜尋站點',
      downloadSiteDesc: '設置指定分類搜尋的站點範圍。',
      movieSites: '電影站點',
      tvSites: '電視劇站點',
      animeSites: '動漫站點',
      saveSites: '儲存站點',
      saveSuccess: '儲存搜尋設置成功',
      saveFailed: '搜尋設置儲存失敗！',
      saveRuleFailed: '規則儲存失敗！',
      movieCategory: '電影',
      tvCategory: '電視劇',
      animeCategory: '動漫',
      downloadUser: '遠程搜尋自動下載用戶',
      multipleNameSearch: '多名稱資源搜尋',
      multipleNameSearchHint: '使用多個名稱（中文、英文等）搜尋站點資源並合並搜尋結果，會增加站點訪問頻率',
      downloadSubtitle: '下載站點字幕',
      downloadSubtitleHint: '檢查站點資源是否有單獨的字幕文件並自動下載',
      mediaSource: '媒體搜尋數據源',
      mediaSourceHint: '搜尋媒體資訊時使用的數據源以及排序',
      filterRuleGroupHint: '搜尋媒體資訊時按選定的過濾規則組對結果進行過濾',
      downloadUserPlaceholder: '用戶ID1,用戶ID2',
      downloadUserHint: '使用Telegram、微信等搜尋時是否自動下載，使用逗號分割，設置為 all 代表所有用戶自動擇優下載',
    ...
    directory: {
      ...
      saveSuccess: '存儲設置儲存成功',
      saveFailed: '存儲設置儲存失敗！',
      directorySaveSuccess: '目錄設置儲存成功',
      directorySaveFailed: '目錄設置儲存失敗！',
      organizeSaveSuccess: '整理選項設置儲存成功',
      organizeSaveFailed: '整理選項設置儲存失敗！',
      duplicateDirectoryName: '存在重複目錄名稱！無法儲存，請修改！',
      defaultDirName: '目錄',
      storageSaveSuccess: '存儲設置儲存成功',
      storageSaveFailed: '存儲設置儲存失敗！',
    },
    rule: {
      customRules: '自定義規則',
      customRulesDesc: '自定義優先級規則項',
      priorityRuleGroups: '優先級規則組',
      priorityRuleGroupsDesc: '預設優先級規則組，以便在搜尋和訂閱中使用。',
      downloadRules: '下載規則',
      ...
      emptyIdError: '存在空ID的規則，無法儲存，請修改！',
      emptyNameError: '存在空名字的規則，無法儲存，請修改！',
      duplicateIdError: '存在重複規則ID！無法儲存，請修改！',
      duplicateNameError: '存在重複規則名稱！無法儲存，請修改！',
      customRuleSaveSuccess: '自定義規則儲存成功',
      customRuleSaveFailed: '自定義規則儲存失敗！',
      emptyGroupNameError: '存在空名字的規則組！無法儲存，請修改！',
      duplicateGroupNameError: '存在重複規則組名稱！無法儲存，請修改！',
      ruleGroupSaveSuccess: '優先級規則組儲存成功',
      ruleGroupSaveFailed: '優先級規則組儲存失敗！',
    ...
    subscribe: {
      ...
      timedSearch: '訂閱定時搜尋',
      timedSearchHint: '每隔指定時間全站搜尋，以補全訂閱可能漏掉的資源',
      searchInterval: '訂閱搜尋時間間隔',
      searchIntervalHint: '設置訂閱搜尋的時間間隔，僅在開啟訂閱定時搜尋時生效',
      ...
      saveSuccess: '訂閱站點儲存成功',
      saveFailed: '訂閱站點儲存失敗！',
      settingsSaveSuccess: '訂閱基礎設置儲存成功',
      settingsSaveFailed: '訂閱基礎設置儲存失敗！',
    },
    cache: {
      title: '緩存管理',
      subtitle: '管理緩存的站點資源',
  ...
  dialog: {
    ...
    userAddEdit: {
      ...
      avatarUploadSuccess: '新頭像上傳成功，待儲存後生效!',
      resetAvatarSuccess: '已重置為默認頭像，待儲存後生效！',
    ...
    searchBar: {
      search: '搜尋',
      searchPlaceholder: '搜尋功能、訂閱、設置...',
      recentSearches: '最近搜尋',
      noRecentSearches: '沒有最近搜尋記錄',
      functions: '功能',
      noFunctionsFound: '沒有匹配的功能',
      plugins: '外掛',
      noPluginsFound: '沒有匹配的外掛',
      subscriptions: '訂閱',
      ...
      siteResources: '站點資源',
      searchInSites: '在站點中搜尋種子資源',
      relatedResources: '相關資源',
      searchTip: '可搜尋電影、電視劇、演員、資源等',
    },
    searchSite: {
      selectSites: '選擇站點',
      siteSearch: '站點搜尋',
    ...
    subscribeShare: {
      ...
      title: '標題',
      description: '說明',
      descriptionHint: '填寫關於該訂閱的說明，訂閱中的搜尋詞、識別詞等將會默認包含在分享中',
      shareUser: '分享用戶',
    ...
    smbConfig: {
      ...
      domain: '網域',
      domainHint: 'SMB網域，如WORKGROUP或域控制器名稱',
      complete: '完成',
      reset: '重置',
    },
    workflowAddEdit: {
    ...
    pluginConfig: {
      ...
      viewData: '查看數據',
      saving: '正在儲存 {name} 配置...',
      saveSuccess: '外掛 {name} 配置已儲存',
      saveFailed: '外掛 {name} 配置儲存失敗：{message}',
    },
    pluginData: {
      title: '外掛數據',
      save: '儲存',
    ...
    pluginMarketSetting: {
      ...
      close: '關閉',
      save: '儲存',
      saveSuccess: '外掛倉庫儲存成功',
      saveFailed: '外掛倉庫儲存失敗：{message}！',
    },
    userAuth: {
      title: '用戶認證',
      codeLabel: '認證碼',
    ...
    subscribeEdit: {
      ...
      searchKeyword: '搜尋關鍵詞',
      searchKeywordHint: '指定搜尋站點時使用的關鍵詞',
      totalEpisode: '總集數',
      ...
      searchImdbid: '使用 ImdbID 搜尋',
      searchImdbidHint: '開使用 ImdbID 精確搜尋資源',
  ...
  error: {
    title: '出錯啦！',
    networkError: '無法獲取到媒體資訊，請檢查網絡連接。',
  ...
  plugin: {
    ...
    installingPlugin: '正在安装外掛...',
    installing: '正在安装 {name} v{version} ...',
    installSuccess: '外掛 {name} 安装成功！',
    installFailed: '外掛 {name} 安装失败：{message}',
    filterPlugins: '過濾外掛',
    name: '名稱',
    hasNewVersion: '有新版本',
    running: '運行中',
    ...
    pleaseInstallFromMarket: '請從外掛市場安裝外掛',
    allPluginsInstalled: '所有外掛已安裝',
    searchPlugins: '搜尋外掛',
    searchPlaceholder: '按外掛名稱或描述搜尋',
    uninstalling: '正在卸載 {name} ...',
    uninstallSuccess: '外掛 {name} 卸载成功！',
    uninstallFailed: '外掛 {name} 卸载失败：{message}',
    updating: '正在更新 {name} ...',
    updateSuccess: '外掛 {name} 更新成功！',
    updateFailed: '外掛 {name} 更新失敗：{message}',
    noPlugins: '沒有安裝外掛',
    installed: '已安裝',
    notInstalled: '未安裝',
    hasUpdate: '可更新',
    ...
    viewLogs: '查看日誌',
    authorHome: '作者主頁',
    confirmUninstall: '是否確認卸載外掛 {name}？',
    confirmReset: '此操作將恢復外掛 {name} 的默認設置，並清除所有相關數據，確定要繼續嗎？',
    resetSuccess: '外掛 {name} 數據已重置',
    resetFailed: '外掛 {name} 重置失敗：{message}',
    ...
    removeFromFolderSuccess: '外掛已移出文件夾',
    operationFailed: '操作失敗',
    saveFolderConfigFailed: '儲存文件夾配置失敗',
    newFolder: '新建文件夾',
    folderName: '文件夾名稱',
    cancel: '取消',
    create: '創建',
    ...
    cloneFeature: '外掛分身功能',
    cloneDescription: '創建外掛的獨立副本，擁有獨立的配置和數據，適用於多賬號、測試環境等場景',
    suffix: '分身後綴',
    ...
    cloneNameHint: '分身外掛的顯示名稱（可選）',
    cloneDefaultName: '{name} 分身',
    cloneDescriptionLabel: '分身描述',
    cloneDescriptionPlaceholder: '描述這個分身的用途和特點...',
    cloneDescriptionHint: '詳細描述分身外掛的用途（可選）',
    cloneDefaultDescription: '{description} (分身版本)',
    cloneVersion: '版本號',
    cloneVersionPlaceholder: '例如：1.0、2.1.0',
    cloneVersionHint: '自定義分身外掛的版本號（可選）',
    cloneIcon: '圖標URL',
    cloneIconPlaceholder: 'https://example.com/icon.png',
    cloneIconHint: '自定義分身外掛的圖標（可選）',
    cloneNotice: '分身外掛創建後默認為禁用狀態，需要手動配置啟用。分身後綴一旦確定無法修改。',
    createClone: '創建分身',
    cloning: '正在創建 {name} 的分身...',
    cloneSuccess: '外掛分身 {name} 創建成功！',
    cloneFailed: '外掛分身創建失敗：{message}',
    cloneFailedGeneral: '外掛分身創建失敗',
    logTitle: '外掛日誌',
    quickAccess: '快速訪問',
    noPluginsWithPage: '暫無可展示的外掛',
    tapToOpen: '點擊返回主界面',
    recentlyUsed: '最近使用',
    allPlugins: '所有外掛',
    noRecentPlugins: '無',
  ...
  profile: {
    ...
    resetAvatarSuccess: '已重置為默認頭像，待儲存後生效！',
    restoreAvatarSuccess: '已還原當前使用頭像！',
    savingInProgress: '正在儲存中，請稍後...',
    usernameRequired: '用戶名不能為空',
    passwordMismatch: '兩次輸入的密碼不一致',
    usernameChangeSuccess: '【{oldName}】更名【{newName}】，用戶資訊儲存成功！',
    saveSuccess: '用戶資訊儲存成功！',
    saveFailedWithNameChange: '【{oldName}】更名【{newName}】，資訊儲存失敗：{message}！',
    saveFailed: '用戶資訊儲存失敗：{message}！',
    nickname: '暱稱',
    ...
    passkeyDomainWarning:
      '通行密鑰（PassKey）的可用性與 {domain} 緊密相關。在公網環境下，請務必在「基本設定」中配置正確的訪問網域。網域變更或配置錯誤將導致通行密鑰無法使用。',
  ...
  downloader: {
    ...
    name: '名稱',
    type: '類型',
    customTypeHint: '自定義下載器類型，用於外掛等場景',
    enabled: '啟用',
    default: '預設',
    host: '地址',
    username: '用戶名',
    ...
    saveSuccess: '下載器設置儲存成功',
    saveFailed: '下載器設置儲存失敗',
    nameRequired: '名稱不能為空',
    nameDuplicate: '名稱已存在',
  ...
  mediaserver: {
    type: '類型',
    customTypeHint: '自定義媒體伺服器類型，用於外掛等場景',
  ...
  setupWizard: {
    ...
    saveStepFailed: '儲存步驟設置失敗',
    basicSettingsSaved: '基礎設置儲存成功',
    saveBasicSettingsFailed: '儲存基礎設置失敗',
    storageSettingsSaved: '存儲設置儲存成功',
    saveStorageSettingsFailed: '儲存存儲設置失敗',
    downloaderSettingsSaved: '下載器設置儲存成功',
    saveDownloaderSettingsFailed: '儲存下載器設置失敗',
    mediaServerSettingsSaved: '媒體服務器設置儲存成功',
    saveMediaServerSettingsFailed: '儲存媒體服務器設置失敗',
    notificationSettingsSaved: '通知設置儲存成功',
    saveNotificationSettingsFailed: '儲存通知設置失敗',
    preferenceSettingsSaved: '偏好設置儲存成功',
    savePreferenceSettingsFailed: '儲存偏好設置失敗',
    ...
    basic: {
      ...
      apiToken: 'API 權杖',
      apiTokenHint: '訪問MoviePilot API 需要的訪問權杖，請記錄下來以便後續使用',
