export default {
  ...
  setting: {
    ...
    system: {
      ...
      aiAgentVerbose: '囉嗦模式',
      aiAgentVerboseHint: '開啟後會在智慧體回覆時顯示工具調用過程',
  ...
  setupWizard: {
    ...
    saveSiteAuthSettingsFailed: '儲存用戶站點認證設置失敗：{message}',
    saveAgentSettingsFailed: '儲存智慧助手設置失敗',
