export default {
  ...
  login: {
    ...
    oauthLoginFailed: 'SSO login failed',
    oauthCallbackError: 'OAuth callback failed, please login again',
  ...
  setting: {
    ...
    system: {
      ...
      authPasskeyEnable: 'Passkey Login',
      ...
      authProviderType: 'Provider Type',
      authProviderName: 'Provider Name',
      authProviderNameHint: 'Name displayed on the login button',
      authClientId: 'Client ID',
      authClientIdHint: 'OAuth2 Client ID',
      authClientSecret: 'Client Secret',
      authClientSecretHint: 'OAuth2 Client Secret',
      authAuthorizationEndpoint: 'Authorization Endpoint',
      authAuthorizationEndpointHint: 'e.g., https://auth.example.com/application/o/authorize/',
      authTokenEndpoint: 'Token Endpoint',
      authTokenEndpointHint: 'e.g., https://auth.example.com/application/o/token/',
      authUserinfoEndpoint: 'UserInfo Endpoint',
      authUserinfoEndpointHint: 'e.g., https://auth.example.com/application/o/userinfo/',
      authRedirectUri: 'Redirect URI (Optional)',
      authRedirectUriHint: 'Leave empty to auto-generate. Fill full URL if manual specification is needed',
      authScope: 'Scope',
      authScopeHint: 'Requested permissions scope, e.g., openid profile email',
      authUsernameField: 'Username Mapping Field',
      authUsernameFieldHint: 'Field to map as username from UserInfo, e.g., preferred_username',
      authNewUserPermissions: 'New User Default Permissions',
      authNewUserPermissionsHint: 'Comma separated, e.g., search,discovery,subscribe,manage',
      authAvatarField: 'Avatar Field',
      authAvatarFieldHint: 'e.g., picture or avatar',
      authAutoCreateUser: 'Auto Create User',
      authAutoCreateUserHint: 'Automatically create account when new user logs in first time',
      authSyncEmail: 'Sync Email',
      authSyncEmailHint: 'Sync email from user info on every login',
      authSyncAvatar: 'Sync Avatar',
      authSyncAvatarHint: 'Sync avatar from user info on every login',
      authSaveSuccess: 'Auth settings saved successfully',
