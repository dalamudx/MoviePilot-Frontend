export default {
  ...
  login: {
    ...
    oauthLoginFailed: 'SSO 登录失败',
    oauthCallbackError: 'OAuth 回调处理失败，请重新登录',
    backToLogin: '返回登录页',
    mfa: {
  ...
  setting: {
    ...
    system: {
      ...
      authPasskeyEnable: '通行密钥',
      authPasskeyEnableHint: '显示通行密钥(Passkey)登录按钮',
      authSettings: '认证设置',
      authSettingsDesc: '设置登录相关功能',
      authEnable: '启用单点登录',
      authProviderType: '认证类型',
      authProviderName: '显示名称',
      authProviderNameHint: '登录按钮上显示的名称',
      authClientId: 'Client ID',
      authClientIdHint: 'OAuth2 Client ID',
      authClientSecret: 'Client Secret',
      authClientSecretHint: 'OAuth2 Client Secret',
      authAuthorizationEndpoint: '授权端点 (Authorization URL)',
      authAuthorizationEndpointHint: '例如: https://auth.example.com/application/o/authorize/',
      authTokenEndpoint: 'Token 端点',
      authTokenEndpointHint: '例如: https://auth.example.com/application/o/token/',
      authUserinfoEndpoint: '用户信息端点',
      authUserinfoEndpointHint: '例如: https://auth.example.com/application/o/userinfo/',
      authRedirectUri: '回调地址 (Redirect URI) - 可选',
      authRedirectUriHint: '通常留空即可，系统会自动生成。如需手动指定，请填写完整URL',
      authScope: 'Scope',
      authScopeHint: '请求的权限范围，例如: openid profile email',
      authUsernameField: '用户名映射字段',
      authUsernameFieldHint: '从用户信息中作为用户名的字段，例如: preferred_username',
      authNewUserPermissions: '新用户默认权限',
      authNewUserPermissionsHint: '逗号分隔，例如: search,discovery,subscribe,manage',
      authAvatarField: '头像字段',
      authAvatarFieldHint: '例如: picture 或 avatar',
      authAutoCreateUser: '自动创建用户',
      authAutoCreateUserHint: '新用户首次登录时自动创建账号',
      authSyncEmail: '同步邮箱',
      authSyncEmailHint: '每次登录时同步用户信息中的邮箱地址',
      authSyncAvatar: '同步头像',
      authSyncAvatarHint: '每次登录时同步用户信息中的头像图片',
      authSaveSuccess: '认证设置保存成功',
